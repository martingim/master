...
plot(t, -(fil-fil(1,1))*0.044, 'DisplayName','fil1.dat*0.044')

load(append(run_folder, "fil2.dat"));
fil = fil2;
plot(t, (fil-fil(1,1))*0.0044, 'DisplayName','fil2.dat*0.0044')
...
plot(t(1:size(padle_ut, 1)), (padle_ut-padle_ut(1))*0.044, 'DisplayName','padle\_ut.dat*0.044')
xlim([0, 3])

plot(t, 0.044*0.308*tanh(t).*sin(2*pi*1.425*(t)), 'DisplayName','0.044\cdot0.308\cdottanh(t)\cdotsin(2\pift)')
...
nexttile;
hold on;
plot(t(1:size(padle_ut, 1)), (padle_ut-padle_ut(1))*0.044, 'DisplayName','padle\_ut.dat')
plot(t, 0.044*0.308*tanh(t).*sin(2*pi*1.425*(t)), '--','DisplayName','0.044*0.308*tanh(t)*sin(2\pift)')
plot(t(1:4:end)-0.03, (fil(1:4:end)-fil(1,1))*0.01,'xk', 'DisplayName','fil3.dat shifted by 0.03s', 'MarkerSize',10)
plot(t-0.03, (fil2-fil2(1))*0.0044, 'DisplayName',"fil2*0.0044")
legend('Location','southeast')
xlabel('time [s]')
ylabel('piston position [m]')
xlim([10 13])
